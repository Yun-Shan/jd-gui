...
NonSeparator						= ([^\t\f\r\n\ \(\)\{\}\[\]\;\,\.\=\>\<\!\~\?\:\+\-\*\/\&\|\^\%\"\']|"#"|"\\")
IdentifierStart					= (\p{L}|\p{Letter_Number}|\p{Currency_Symbol}|\p{Connector_Punctuation})
IdentifierPart					= ({IdentifierStart}|{Digit}|\p{Combining_Mark}|\p{Non_Spacing_Mark}|[\u0000-\u0008]|[\u000E-\u001B]|[\u007F-\u009F]|\p{Format}|("\\"{EscapedSourceCharacter}))
